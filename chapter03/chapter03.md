...
* 전략 패턴의 적용
  ...
  * Context 가 어떤 전략을 사용할지 정하는 것은 Context 를 사용하는 Client 가 결정하는게 더 유연한 디자인이 된다.
  ...
  ![전략 패턴에서 Client의 역할](img/3-3.png)
...
![JdbcContext로 분리된 클래스 다이어그램](img/3-4.PNG)

![런타임 시에 만들어지는 오브젝트 레벨의 의존관계](img/3-5.PNG)
...
![JdbcContext에 사용된 템플릿 콜백](img/3-8.PNG)
